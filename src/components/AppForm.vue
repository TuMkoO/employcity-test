  ...
  <form class="form" action="" method="get">
    <div class="form-row">
      <div class="form-col form-col_1">
        <AppFormSelect :options="options" placeholder="Выберите тип системы" />
      </div>
      <div class="form-col form-col_1">
        <input
          class="form-input"
      ...
      <div class="form-col form-col_2">
        <label class="form-range-label">
          Sed ut perspiciatis, unde omnis iste natus <span>{{ range }} %</span>
        </label>
        <input
          v-model="range"
          class="form-range"
      ...
      <div class="form-col form-col_1">
        <label @click="changeFile" class="form-file-upload btn btn_white">
          <input type="file" name="file" @change="uploadFile" />
          <span class="form-file-upload__icon">
            <svg
    ...
    <div class="form-row form-row_controls justify-content-center">
      <div class="form-col form-col_1">
...
const options = [
  { name: "Sed ut perspiciatis", value: 1 },
  { name: "Nemo enim ipsam", value: 2 },
  { name: "Et harum quidem", value: 3 },
  { name: "Temporibus autem", value: 4 },
  { name: "Itaque earum rerum", value: 5 },
  { name: "Sed ut perspiciatis", value: 6 },
  { name: "Nemo enim ipsam", value: 7 },
  { name: "Et harum quidem", value: 8 },
  { name: "Temporibus autem", value: 9 },
  { name: "Itaque earum rerum", value: 10 },
...
const uploadFile = (file) => {
  fileName.value = file?.target.files[0]?.name;
};
</script>
